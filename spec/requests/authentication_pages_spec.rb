...
# 	before { visit signin_path }
# 	#it { save_and_open_page; should have_slector('h1', text: 'Sign in')}
# 	it { should have_selector('title', text: 'Sign in')}
...
#    			end
#    			describe "submitting a PUT request to the the User#update action" do
#    				before { put user-path(wrong_user)}
